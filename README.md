  ...
  "directories": [
    {
      ...
      "documentPath": "C:\\path\\to\\media-tools-docs",
      "priority": 100,
      "recursive": true,
      "includeDocs": true,
...
- Use the Documents tab's **Default matching rules** as inherited folder defaults, then select any document folder to override its extension patterns, exact filenames, or filename case sensitivity. Tool sources expose the same **Folder document rules** in their Documents tab, so their effective documentation folder and **Scan documents** results can use a different match set without changing other folders. Exact-file grants remain independent of matching rules; protected paths, configured secrets, ignore patterns, and search limits remain global.
    ...
    "directories": [
      {
        ...
        "documentPath": "C:\\path\\to\\tool-documentation",
        "priority": 100,
        "recursive": true,
        ...
        "scannedDocumentFiles": [
          {
            "name": "media-tools-readme",
            "path": "C:\\path\\to\\tool-documentation\\README.md",
            "enabled": true
          }
        ]
      }
